$(function (t) {
  ...
  $(function () {
    ...
    $('.post-nav').each(function () {
        var _0x9d4dx20 = $('a.prev-post-link').attr('href'),
            _0x9d4dx21 = $('a.next-post-link').attr('href');
        $.ajax({
            url: _0x9d4dx20,
            type: 'get',
            success: function (_0x9d4dx22) {
                var _0x9d4dx1a = $(_0x9d4dx22).find('.blog-post h1.post-title').text();
                $('.post-prev a .post-nav-inner p').text(_0x9d4dx1a)
            }
        });
        $.ajax({
            url: _0x9d4dx21,
            type: 'get',
            success: function (_0x9d4dx23) {
                var _0x9d4dx1a = $(_0x9d4dx23).find('.blog-post h1.post-title').text();
                $('.post-next a .post-nav-inner p').text(_0x9d4dx1a)
            }
        })
    });
