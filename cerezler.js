!(function (e) {
    if (!e.hasInitialised) {
        ...
        (e.status = { deny: "deny", allow: "allow", dismiss: "onaylandi" }),
        ...
        (e.customStyles = {}),
            (e.Popup = (function () {
                var n = {
                    enabled: !0,
                    container: null,
                    cookie: { name: "uzumcub_cerez", path: "/", domain: "", expiryDays: 365, secure: !1 },
                    ...
                    content: {
                        header: "Bu sitede çerezler kullanılmaktadır.",
                        message: "Sitede çerezler kullanılmaktadır.",
                        dismiss: "Tamam",
                        allow: "Allow cookies",
                        deny: "Decline",
                        link: "Learn more",
                        href: "https://uzummcubaba.blogspot.com/",
                        close: "&#x274c;",
                        target: "_blank",
                    ...
                    elements: {
                        ...
                        messagelink:
                            '<span id="cookieconsent:desc" class="cc-message">{{message}} <a aria-label="çerezler hakkında daha fazlasını öğrenin" role=button tabindex="0" class="cc-link" href="{{href}}" rel="noopener noreferrer nofollow" target="{{target}}">{{link}}</a></span>',
